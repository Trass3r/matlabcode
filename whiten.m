...
% 
% xs = -2:0.05:6.5;
% A = [sin(xs); 1.2*cos(1.5.*xs)];
% plot(A');
% plot(xs, A');
% plot(xs, A'); legend('sin', 'cos');
% plot(xs, A'); legend('sin', 'cos'); axes;
% plot(xs, A'); legend('sin', 'cos'); axes on;
% plot(xs, A'); legend('sin', 'cos'); axis on;
% plot(xs, A'); legend('sin', 'cos'); grid on;
% A
% cov(A)
% cov(A')
% plot(xs, A'); legend('sin', 'cos'); grid on;
...
% A
% V'*A
% plot(xs, V'*A); legend('sin', 'cos'); grid on;
% cov(V'*A)
% cov((V'*A)*)
% cov((V'*A)')
% plot(xs, V'*A); legend('sin', 'cos'); grid on;
